...
<html lang="en">
    <head>
        ...
        <!-- App title -->
        <title>Portal Noticias | Añadir Publicacion</title>
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Editar Publicacion </h4>
...
<label for="exampleInputEmail1">Titulo de la Publicacion</label>
...
<div class="col-sm-12">
 <div class="card-box">
<h4 class="m-b-30 m-t-0 header-title"><b>Detalles de la Publicacion</b></h4>
...
<div class="col-sm-12">
 <div class="card-box">
<h4 class="m-b-30 m-t-0 header-title"><b>Imagen de la publicacion</b></h4>
