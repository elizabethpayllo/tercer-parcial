...
if($query)
{
$msg="Sub-Categoría creada correctamente ";
}
else{
...
<html lang="en">
    <head>
        ...
        <title>Portal Noticias | Añadir Sub Categoría</title>
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Añadir Sub-Categoría</h4>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    <h4 class="m-t-0 header-title"><b>Añadir Sub-Categoría </b></h4>
                                    <hr />
...
<?php } ?>
    ...
    <div class="form-group">
                                                    <label class="col-md-2 control-label">Sub-Categoría</label>
                                                    <div class="col-md-10">
	                                            ...
	                                            <div class="form-group">
	                                                <label class="col-md-2 control-label">Descripcíon de la Sub-Categoría</label>
	                                                <div class="col-md-10">
