...
if($query)
{
$msg="Publicación de imagen destacada atualizada ";
}
else{
...
<html lang="en">
    <head>
        ...
        <!-- App title -->
        <title>Portal Noticias | Añadir Publicación</title>
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Actualizar Imágen </h4>
...
<div class="col-sm-12">
 <div class="card-box">
<h4 class="m-b-30 m-t-0 header-title"><b>Imágen de la Publicación Actual</b></h4>
...
<div class="col-sm-12">
 <div class="card-box">
<h4 class="m-b-30 m-t-0 header-title"><b>Nueva Imágen Destacada</b></h4>
